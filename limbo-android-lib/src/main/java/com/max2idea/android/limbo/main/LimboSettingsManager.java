...
public class LimboSettingsManager extends PreferenceActivity {
    ...
    public void promptVNCPass(final Activity activity) {
        ...
        alertDialog.setButton(DialogInterface.BUTTON_POSITIVE, getString(android.R.string.ok), (dialog, which) -> {
        ...
        alertDialog.setButton(DialogInterface.BUTTON_NEGATIVE, getString(R.string.Cancel), (dialog, which) -> LimboSettingsManager.setVNCPass(activity, null));


        alertDialog.setOnCancelListener(dialog -> LimboSettingsManager.setVNCPass(activity, null));
        alertDialog.show();
